...
class AutoList extends GetView<StoreController> {
  @override
  Widget build(BuildContext context) {
    String apptitle = 'Auto 1'.tr;
    return Container(
      child: Column(
                ...
                InkWell(
                  child: Row(
                    children: [
                      ClipOval(
                        child: Image.network(
                          "https://i.ibb.co/8jYD3jZ/download.jpg",
                          width: 50,
                        ),
                      ),
                      Padding(
                ...
                child: Padding(
                  ...
                  child: IntrinsicHeight(
                    child: Row(
                      ...
                      children: StoreController().autoList.map<Widget>((e) {
