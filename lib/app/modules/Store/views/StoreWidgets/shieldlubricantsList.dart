...
class ShieldLubricantsList extends GetView<StoreController> {
  @override
  Widget build(BuildContext context) {
    String apptitle = 'Shield Lubricants'.tr;
    return Container(
      child: Column(
                ...
                InkWell(
                  child: Row(
                    children: [
                      ClipOval(
                        child: Image.network(
                          "https://i.ibb.co/Wx5LC6N/1581971426209.png",
                          width: 50,
                        ),
                      ),
                      Padding(
                ...
                InkWell(
                  ...
                  onTap: () {
                    Navigator.pushNamed(context, Routes.STORE_ALL_PRODUCTS,
                        arguments: {
                          'apptitle': apptitle,
                          'list': StoreController().shieldLubricantsList
                        });
                  },
                ),
              ],
