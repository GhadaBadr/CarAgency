...
class MafraList extends GetView<StoreController> {
  @override
  Widget build(BuildContext context) {
    String apptitle = 'Mafra'.tr.toUpperCase();
    return Container(
      child: Column(
                ...
                InkWell(
                  child: Row(
                    children: [
                      ClipOval(
                        child: Image.network(
                          "https://i.ibb.co/b6T74vD/download-1.png",
                          width: 50,
                        ),
                      ),
                      Padding(
                ...
                InkWell(
                  ...
                  onTap: () {
                    Navigator.pushNamed(context, Routes.STORE_ALL_PRODUCTS,
                        arguments: {
                          'apptitle': apptitle,
                          'list': StoreController().mafraList
                        });
                  },
                ),
              ],
                ...
                child: Padding(
                  ...
                  child: IntrinsicHeight(
                    child: Row(
                      ...
                      children: StoreController().mafraList.map<Widget>((e) {
