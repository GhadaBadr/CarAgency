...
class Mobil1List extends GetView<StoreController> {
  @override
  Widget build(BuildContext context) {
    String apptitle = 'Mobil 1'.tr;
    return Container(
      child: Column(
                ...
                InkWell(
                  child: Row(
                    children: [
                      ClipOval(
                        child: Image.network(
                          "https://w7.pngwing.com/pngs/699/691/png-transparent-mobil-1-logo-exxonmobil-super-b-miscellaneous-cdr-text.png",
                          width: 50,
                        ),
                      ),
                      Padding(
                ...
                InkWell(
                  ...
                  onTap: () {
                    Navigator.pushNamed(context, Routes.STORE_ALL_PRODUCTS,
                        arguments: {
                          'apptitle': apptitle,
                          'list': StoreController().mobil1List
                        });
                  },
                ),
              ],
                ...
                child: Padding(
                  ...
                  child: IntrinsicHeight(
                    child: Row(
                      ...
                      children: StoreController().mobil1List.map<Widget>((e) {
