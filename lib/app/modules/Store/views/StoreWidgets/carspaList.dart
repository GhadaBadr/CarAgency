...
class CarSpaList extends GetView<StoreController> {
  @override
  Widget build(BuildContext context) {
    String apptitle = 'Car Spa'.tr;
    return Container(
      child: Column(
                ...
                InkWell(
                  child: Row(
                    children: [
                      ClipOval(
                        child: Image.network(
                          "https://i.ibb.co/9Y4KTb8/service0.png",
                          width: 50,
                        ),
                      ),
                      Padding(
                ...
                InkWell(
                  ...
                  onTap: () {
                    Navigator.pushNamed(context, Routes.STORE_ALL_PRODUCTS,
                        arguments: {
                          'apptitle': apptitle,
                          'list': StoreController().carspaList
                        });
                  },
                ),
              ],
                ...
                child: Padding(
                  ...
                  child: IntrinsicHeight(
                    child: Row(
                      ...
                      children: StoreController().carspaList.map<Widget>((e) {
